...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const m51 = document.getElementById('m5-1');
  const m52 = document.getElementById('m5-2');
  const m61 = document.getElementById('m6-1');
  const m62 = document.getElementById('m6-2');
  const m63 = document.getElementById('m6-3');
  ...
  const questionButton = document.getElementById('questionButton');
    ...
    settingButton.addEventListener('click', () => {
      ...
      m51.style.display = 'none';
      m52.style.display = 'none';
      m61.style.display = 'none';
      m62.style.display = 'none';
      m63.style.display = 'none';
      // 設定画面を表示する
    ...
    back_titleSceneButton.addEventListener('click', () => {
      ...
      m51.style.display = 'inline';
      m52.style.display = 'inline';
      m61.style.display = 'inline';
      m62.style.display = 'inline';
      m63.style.display = 'inline';
